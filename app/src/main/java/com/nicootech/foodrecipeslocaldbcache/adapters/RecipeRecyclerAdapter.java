package com.nicootech.foodrecipeslocaldbcache.adapters;
...
import com.nicootech.foodrecipeslocaldbcache.util.Constants;
...
public class RecipeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if(itemViewType == RECIPE_TYPE){
            ...
            Uri path = Uri.parse("android.resource://com.nicootech.foodrecipeslocaldbcache.drawable/" + mRecipes.get(i).getImage_url());
